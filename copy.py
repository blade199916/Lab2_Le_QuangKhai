...
Twilio_Number="+18443646365", #this is your own Twilio number
account_sid = 'AC3da63370504fbed18cbfce0b97a8997e'  #this is your account SID
auth_token = 'ce7ddeefb4c79d7cf0d840e84b4c169b'     #this is your own auth_token

from_address = "dieungo54321@gmail.com" #this is your own gmail account
app_password = 'wcgjelshyrvciltr' # a token for gmail, this is the app password from Gmail Security
...
def excel():
    ...
    sheet.cell(row=1, column=13).value = "Weight(lbs)"
    sheet.cell(row=1, column=14).value = "Height(ft"
...
def insert():
    ...
    if (
        ...
        sheet.cell(row=current_row + 1, column=13).value = weight_field.get()
        sheet.cell(row=current_row + 1, column=14).value = height_field.get()
...
def register_form():
    ...
    bg = PhotoImage(file=r"BackgroundPicture1.png", height=550, width=900)
    ...
    # create a Name label
    name = Label(root, text="First Name", bg="light green", fg="black", font=("Calibri", 13))

    # create a Course label
    course = Label(
        root, text="Middle Name", bg="light green", fg="black", font=("Calibri", 13)
    )

    # create a Semester label
    sem = Label(root, text="Last Name", bg="light green", fg="black", font=("Calibri", 13))

    # create a graduation year. lable
    grad = Label(root, text="DOB", bg="light green", fg="black", font=("Calibri", 13))
    ...
    email = Label(root, text="Email", bg="light green", fg="black", font=("Calibri", 13))

    # create a address label
    address = Label(
        root, text="Street Address", bg="light green", fg="black", font=("Calibri", 13)
    )
    ...
    gender = Label(
        root, text="Gender", bg="light green", fg="black", font=("Calibri", 13)
    )
    # create a weight label
    weight = Label(
        root, text="Weight", bg="light green", fg="black", font=("Calibri", 13)
    )
    # create height label
    height = Label(
        root, text="Height", bg="light green", fg="black", font=("Calibri", 13)
    )
    ...
    weight_field= Entry(root, textvariable=weight_in)
    height_field= Entry(root, textvariable=height_in)
    ...
    gender_field.bind("<Return>", focus8)
    
    weight_field.bind("<Return>", focus9)
    
    height_field.bind("<Return>", focus10)
    ...
    phone_field.grid(row=8, column=1, ipadx="100")
    email_field.grid(row=9, column=1, ipadx="100")
    address_field.grid(row=10, column=1, ipadx="100")
    current_date_field.grid(row=11, column=1, ipadx="100")
    gender_field.grid(row=5, column=1, ipadx="100")
    weight_field.grid(row=6, column=1, ipadx="100")
    height_field.grid(row=7, column=1, ipadx="100")
...
def register():
    ...
    register_screen.geometry("320x400")

    # Background image for window
    # refrenced above
    bg = PhotoImage(file=r"BackgroundPicture3.png", height=500, width=320)
...
def login():
    ...
    login_screen.geometry("320x500")

    bg = PhotoImage(file=r"BackgroundPicture2.png", height=500, width=320)
    ...
    Label(
        login_screen, text="Username * ", fg="black", bg="light blue", font=("Calibri", 13)
    ).grid(row=3, column=0)
    username_login_entry = Entry(login_screen, textvariable=username_verify)
    username_login_entry.grid(row=4, column=0)

    Label(
        login_screen, text="Password * ", fg="black", bg="light blue", font=("Calibri", 13)
    ).grid(row=6, column=0)
...
def main_account_screen():
    ...
    Button(text="Login", height="3", width="39", bg="grey", command=login).grid(
        row=3, column=2
    )

    Button(text="Register", height="3", width="39", bg="grey", command=register).grid(
        row=5, column=2
    )
